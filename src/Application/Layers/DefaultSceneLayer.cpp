...
#pragma endregion 
	...
	/*	for (int ix = 0; ix < 50; ix++)
		...
		{
			// Set position in the scene
			door->SetPostion(glm::vec3(10.0f, -14.5f, 0.0f));
...
#pragma endregion 
		...
		{
			// Set position in the scene
			chestBandage->SetPostion(glm::vec3(-6.5f, -13.5f, 0.0f));
			chestBandage->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
			chestBandage->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			bandageObj->SetPostion(glm::vec3(-6.5f, -13.5f, 0.0f));
			bandageObj->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
			bandageObj->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			door->SetPostion(glm::vec3(-7.5f, -12.0f, 0.0f));
