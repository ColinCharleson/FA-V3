...
void DefaultSceneLayer::_CreateScene2()
{
	using namespace Gameplay;
	using namespace Gameplay::Physics;
...
#pragma endregion 
		...
		{
			// Set position in the scene
			chestKey->SetPostion(glm::vec3(9.0f, -6.5f, 0.0f));
			chestKey->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
			chestKey->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			keyObj->SetPostion(glm::vec3(9.0f, -6.5f, 0.0f));
			keyObj->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
			keyObj->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			chestBandage->SetPostion(glm::vec3(-6.0f, -14.5f, 0.0f));
			chestBandage->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
			chestBandage->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			bandageObj->SetPostion(glm::vec3(-6.0f, -14.5f, 0.0f));
			bandageObj->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
			bandageObj->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			door->SetPostion(glm::vec3(-7.3f, -12.5f, 0.0f));
			door->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
		...
		{
			// Set position in the scene
			ribcage->SetPostion(glm::vec3(2.0f, -5.0f, 0.0f));
			ribcage->SetRotation(glm::vec3(90.0f, 0.0f, 67.0f));
		...
		{
			// Set position in the scene
			ribcage2->SetPostion(glm::vec3(-2.0f, -7.5f, 0.0f));
			ribcage2->SetRotation(glm::vec3(90.0f, 0.0f, 67.0f));
		...
		{
			// Set position in the scene
			ribcage3->SetPostion(glm::vec3(5.0f, -7.0f, 0.0f));
			ribcage3->SetRotation(glm::vec3(90.0f, 0.0f, 10.0f));
		...
		{
			// Set position in the scene
			ribcage4->SetPostion(glm::vec3(11.5f, -6.0f, 0.0f));
			ribcage4->SetRotation(glm::vec3(90.0f, 0.0f, 30.0f));
		...
		{//walls start///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			{
				// Set position in the scene
				wall3->SetPostion(glm::vec3(-2.5f, -7.5f, 1.0f));
				wall3->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
				wall3->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall4->SetPostion(glm::vec3(-5.0f, -10.0f, 1.0f));
				wall4->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
				wall4->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall5->SetPostion(glm::vec3(-7.5f, -12.5f, 1.0f));
			...
			{
				// Set position in the scene
				wall6->SetPostion(glm::vec3(-5.f, -15.0f, 1.0f));
				wall6->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall6->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall7->SetPostion(glm::vec3(0.f, -15.f, 1.0f));
				wall7->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall7->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall8->SetPostion(glm::vec3(5.f, -15.f, 1.0f));
				wall8->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall8->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall9->SetPostion(glm::vec3(10.0f, -15.0f, 1.0f));
			...
			{
				// Set position in the scene
				wall10->SetPostion(glm::vec3(12.5f, -12.5f, 1.0f));
				wall10->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall10->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall11->SetPostion(glm::vec3(12.5f, -7.5f, 1.0f));
				wall11->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall11->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall12->SetPostion(glm::vec3(10.f, -5.f, 1.0f));
				wall12->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
				wall12->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall13->SetPostion(glm::vec3(7.5f, -7.5f, 1.0f));
				wall13->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
				wall13->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall14->SetPostion(glm::vec3(5.0f, -10.0f, 1.0f));
				wall14->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall14->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall15->SetPostion(glm::vec3(2.5f, -7.5f, 1.0f));
				wall15->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall15->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall16->SetPostion(glm::vec3(2.5f, -2.5f, 1.0f));
				wall16->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall16->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
		...
		{
			// Set position in the scene
			skeleton1->SetPostion(glm::vec3(10.0f, -7.5f, 0.1f));
			skeleton1->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
			skeleton1->SetScale(glm::vec3(0.8f, 0.8f, 0.8f));
...
void DefaultSceneLayer::_CreateScene3()
{
	using namespace Gameplay;
	using namespace Gameplay::Physics;
...
#pragma endregion 
		...
		{
			// Set position in the scene
			chestKey->SetPostion(glm::vec3(8.0f, -2.5f, 0.0f));
			chestKey->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
			chestKey->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			keyObj->SetPostion(glm::vec3(8.0f, -2.5f, 0.0f));
			keyObj->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
			keyObj->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			chestAmmo2->SetPostion(glm::vec3(16.5f, -6.5f, 0.0f));
			chestAmmo2->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
			chestAmmo2->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			Ammo2->SetPostion(glm::vec3(16.5f, -6.5f, 0.0f));
			Ammo2->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
			Ammo2->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			door->SetPostion(glm::vec3(5.0f, -0.2f, 0.0f));
			door->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
		...
		{
			// Set position in the scene
			spike1->SetPostion(glm::vec3(15.0f, -5.0f, 0.0f));
			spike1->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
		...
		{
			// Set position in the scene
			slime1->SetPostion(glm::vec3(12.5f, -2.0f, 0.0f));
			slime1->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
		...
		{//walls start///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			{
				// Set position in the scene
				wall4->SetPostion(glm::vec3(0.0f, -10.0f, 1.0f));
				wall4->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall4->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall5->SetPostion(glm::vec3(5.0f, -10.0f, 1.0f));
				wall5->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall5->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall6->SetPostion(glm::vec3(10.f, -10.0f, 1.0f));
				wall6->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall6->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall7->SetPostion(glm::vec3(15.f, -10.f, 1.0f));
				wall7->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall7->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall8->SetPostion(glm::vec3(17.5f, -7.5f, 1.0f));
			...
			{
				// Set position in the scene
				wall9->SetPostion(glm::vec3(17.5f, -2.5f, 1.0f));
				wall9->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall9->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall10->SetPostion(glm::vec3(15.0f, -0.0f, 1.0f));
				wall10->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
				wall10->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall11->SetPostion(glm::vec3(10.0f, 0.0f, 1.0f));
				wall11->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
				wall11->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall12->SetPostion(glm::vec3(5.f, 0.f, 1.0f));
				wall12->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
				wall12->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall13->SetPostion(glm::vec3(7.5f, -2.5f, 1.0f));
				wall13->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
				wall13->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall14->SetPostion(glm::vec3(2.5f, -2.5f, 1.0f));
				wall14->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
				wall14->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall15->SetPostion(glm::vec3(10.0f, -5.0f, 1.0f));
				wall15->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
				wall15->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
		...
		{
			// Set position in the scene
			skeleton1->SetPostion(glm::vec3(10.0f, -1.5f, 0.1f));
			skeleton1->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
			skeleton1->SetScale(glm::vec3(0.8f, 0.8f, 0.8f));
...
void DefaultSceneLayer::_CreateScene4()
{
	using namespace Gameplay;
	using namespace Gameplay::Physics;
...
#pragma endregion 
		...
		{
			// Set position in the scene
			chestAmmo1->SetPostion(glm::vec3(16.5f, -4.0f, 0.0f));
			chestAmmo1->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
			chestAmmo1->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			Ammo1->SetPostion(glm::vec3(16.5f, -4.0f, 0.0f));
			Ammo1->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
			Ammo1->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			door->SetPostion(glm::vec3(2.3f, -12.5f, 0.0f));
			door->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
		...
		{
			// Set position in the scene
			spike1->SetPostion(glm::vec3(5.0f, -5.0f, 0.0f));
			spike1->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
		...
		{
			// Set position in the scene
			slime1->SetPostion(glm::vec3(-4.0f, -8.0f, 0.0f));
			slime1->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
		...
		{//walls start///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			{
				// Set position in the scene
				wall4->SetPostion(glm::vec3(-5.0f, -5.0f, 1.0f));
				wall4->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
				wall4->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall5->SetPostion(glm::vec3(-7.5f, -7.5f, 1.0f));
				wall5->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
				wall5->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall11->SetPostion(glm::vec3(0.0f, -10.0f, 1.0f));
				wall11->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall11->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall12->SetPostion(glm::vec3(7.5f, -7.5f, 1.0f));
			...
			{
				// Set position in the scene
				wall13->SetPostion(glm::vec3(10.0f, -5.0f, 1.0f));
				wall13->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall13->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall14->SetPostion(glm::vec3(15.0f, -5.0f, 1.0f));
				wall14->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall14->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall15->SetPostion(glm::vec3(17.5f, -2.5f, 1.0f));
				wall15->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall15->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall16->SetPostion(glm::vec3(15.0f, 0.0f, 1.0f));
				wall16->SetRotation(glm::vec3(90.0f, 0.0f, -0.0f));
				wall16->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall17->SetPostion(glm::vec3(10.f, 0.f, 1.0f));
				wall17->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
				wall17->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall18->SetPostion(glm::vec3(5.f, 0.f, 1.0f));
				wall18->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
				wall18->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
		...
		{
			// Set position in the scene
			skeleton1->SetPostion(glm::vec3(0.0f, -14.0f, 0.1f));
			skeleton1->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
			skeleton1->SetScale(glm::vec3(0.8f, 0.8f, 0.8f));
...
void DefaultSceneLayer::_CreateScene5()
{
	using namespace Gameplay;
	using namespace Gameplay::Physics;
...
#pragma endregion 
		...
		{
			// Set position in the scene
			chestKey->SetPostion(glm::vec3(-2.0f, -1.0f, 0.0f));
			chestKey->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
			chestKey->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			keyObj->SetPostion(glm::vec3(-2.0f, -1.0f, 0.0f));
			keyObj->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
			keyObj->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			chestBandage->SetPostion(glm::vec3(17.0f, -2.5f, 0.0f));
		...
		{
			// Set position in the scene
			bandageObj->SetPostion(glm::vec3(17.0f, -2.5f, 0.0f));
		...
		{
			// Set position in the scene
			chestAmmo2->SetPostion(glm::vec3(13.0f, -7.5f, 0.0f));
			chestAmmo2->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
			chestAmmo2->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			Ammo2->SetPostion(glm::vec3(13.0f, -7.5f, 0.0f));
			Ammo2->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
			Ammo2->SetScale(glm::vec3(0.4f));
		...
		{
			// Set position in the scene
			door->SetPostion(glm::vec3(15.0f, -14.8f, 0.0f));
			door->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
		...
		{
			// Set position in the scene
			spike1->SetPostion(glm::vec3(15.0f, -12.5f, 0.0f));
			spike1->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
		...
		{
			// Set position in the scene
			slime1->SetPostion(glm::vec3(15.0f, -5.0f, 0.0f));
			slime1->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
		...
		{//walls start///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			{
				// Set position in the scene
				wall2->SetPostion(glm::vec3(0.0f, -5.0f, 1.0f));
				wall2->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall2->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall3->SetPostion(glm::vec3(5.0f, -5.0f, 1.0f));
				wall3->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall3->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall4->SetPostion(glm::vec3(10.0f, -5.0f, 1.0f));
				wall4->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall4->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall5->SetPostion(glm::vec3(10.f, 0.f, 1.0f));
				wall5->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
				wall5->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall6->SetPostion(glm::vec3(5.0f, 0.0f, 1.0f));
				wall6->SetRotation(glm::vec3(90.0f, 0.0f, 180.0f));
				wall6->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall7->SetPostion(glm::vec3(15.f, 0.f, 1.0f));
				wall7->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall7->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall8->SetPostion(glm::vec3(17.5f, -2.5f, 1.0f));
				wall8->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall8->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall9->SetPostion(glm::vec3(17.5f, -7.5f, 1.0f));
				wall9->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall9->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall10->SetPostion(glm::vec3(17.5f, -12.5f, 1.0f));
				wall10->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
				wall10->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall11->SetPostion(glm::vec3(12.5f, -12.5f, 1.0f));
				wall11->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
				wall11->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall12->SetPostion(glm::vec3(12.5f, -7.5f, 1.0f));
				wall12->SetRotation(glm::vec3(90.0f, 0.0f, 90.0f));
				wall12->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
			...
			{
				// Set position in the scene
				wall13->SetPostion(glm::vec3(15.0f, -15.0f, 1.0f));
				wall13->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
				wall13->SetScale(glm::vec3(0.5f, 0.5f, 0.5f));
		...
		{
			// Set position in the scene
			spider1->SetPostion(glm::vec3(16.0f, -13.0f, 0.0f));
			spider1->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
			spider1->SetScale(glm::vec3(0.6f, 0.6f, 0.6f));
		...
		{
			// Set position in the scene
			spider2->SetPostion(glm::vec3(13.0f, -13.0f, 0.0f));
			spider2->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
			spider2->SetScale(glm::vec3(0.6f, 0.6f, 0.6f));
		...
		{
			// Set position in the scene
			skeleton1->SetPostion(glm::vec3(15.0f, -6.0f, 0.1f));
			skeleton1->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
			skeleton1->SetScale(glm::vec3(0.8f, 0.8f, 0.8f));
